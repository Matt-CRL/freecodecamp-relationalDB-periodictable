...
--
-- Name: properties fk_atomic_number_name; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_atomic_number_name FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties fk_proerties_types; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_proerties_types FOREIGN KEY (type_id) REFERENCES public.types(type_id);
